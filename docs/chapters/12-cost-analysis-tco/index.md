...
- **Bandwidth costs** — the network traffic generated by propagating transactions and blocks to all nodes
- **Latency costs** — the business impact of slower transaction confirmation compared to centralized alternatives
- **Energy costs** — particularly significant for proof-of-work networks, where mining electricity can dominate all other costs
